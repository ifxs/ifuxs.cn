...
<header class="comment-header">
	<h1 class="comment-title"><?php _e( 'Comments', 'wplook' ); ?></h1>
	<h2 class="comment-number">
		<?php	printf( _n( 'One Coment', '%1$s Comments', get_comments_number(), 'wplook' ),	number_format_i18n( get_comments_number() ), '<em>' . get_the_title() . '</em>' );	?>
	</h2>
	<span><a href="<?php bloginfo('comments_rss2_url'); ?>" title="<?php _e('Comments RSS', 'wplook'); ?>"><?php _e('RSS', 'wplook'); ?></a></span>
</header>
