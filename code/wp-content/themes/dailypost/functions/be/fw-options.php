...
array( "name" => "tab_content_0",
	...
	array("name" => "
		 <div class=\"buy-message\"><p>First of all thank you for choosing one of StylishWP Themes namely <strong>DailyPost</strong>, your choice is greatly appreciated!</p>

<p>Moreover, you will always receive timely and prompt answers at our <a href=\"https://wordpress.org/support/theme/dailypost\">Support Forum</a>. </p>
...
<p>Hope you will enjoy it.</p></div>
	...
	array("name" => " <script src=\"http://platform.twitter.com/widgets.js\" type=\"text/javascript\"></script> <a href=\"http://twitter.com/share\" class=\"twitter-share-button\" data-via=\"stylishwp\" data-url=\"http://stylishwp.com/dailypost/\" data-text=\"DailyPost is a new intresting theme ideal for your everyday notes and thoughts.\" >Tweet</a><p></p>",
		"type" => "infotext"),
	
	array("name" => "<div id=\"fb-root\"></div><script src=\"http://connect.facebook.net/en_US/all.js?ver=3.2.1#xfbml=1\"></script><fb:like href=\"http://stylishwp.com/dailypost/\" send=\"true\" width=\"580\" show_faces=\"true\" action=\"recommend\" ></fb:like>",
		"type" => "infotext"),
...
function wplook_admin_css() {
	...
	echo ' <link rel="stylesheet" type="text/css" media="screen" href="'.get_template_directory_uri().'/functions/be/css.css" /> ';
...
function wpl_add_admin() {
	...
	add_theme_page($themename." Options", 'StylishWP Panel', 'edit_theme_options', 'fw-options.php', 'wpl_admin', '1');
}
...
?>
	...
	<div id="wrap_fm"><!-- [ Header ]-->
		<div class="header_fm">
			<div class="logo_fm">StylishWP</div>
		...
		<div class="top_menu_fm">
			<a title="DailyPost PRO" target="_blank" class="blogolife-pro" href="http://stylishwp.com/dailypost/">DailyPost</a>
            <a title="Product help and support center" target="_blank" class="support_fm" href="https://wordpress.org/support/theme/dailypost">Support</a>
		</div>
